            ...
            for (BluetoothDevice device : pairedDevices) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(Bluetooth.this, "Sincronizando...", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            Toast.makeText(Bluetooth.this, "Conexión exitosa", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(Bluetooth.this, MainActivity.class);
                            startActivity(intent);
                        } catch (IOException e) {
                            Toast.makeText(Bluetooth.this, "Fallas en la conexión", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
